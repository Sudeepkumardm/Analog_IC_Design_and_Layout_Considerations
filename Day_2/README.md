...
We now give separate voltage sources to each of the MOSFETs to get the desired gain.
...
![Region Operation](Common_Source_amplifier_gain_analysis/Region_3rdCkt.png)
...
![Diff Amp Schematic](Diffrential_Amplifier/DiffAmp_Schematic.png)

---

### 📌 Alternate Schematic View

![Diff Amp Schematic Alt](Diffrential_Amplifier/DiffAmp_Schematic1.png)

---

### 📊 Differential Output Response

![Diff Amp Output](Diffrential_Amplifier/DiffAmp_Output.png)
...
- Biasing determines the **region of operation**.
- Comparing circuit variants improves **design optimization**.

### Differential Amplifier
- Amplifies the **difference between two inputs**.
- Rejects **common-mode noise**.
- Core building block for **operational amplifiers (Op-Amps)** and analog ICs.
